...
function isotopeinwp_scripts() {
	//if ( is_page( 'our-projects' ) ) {
		wp_register_script( 'imagesloaded', get_theme_file_uri( '/js/libs/imagesloaded.pkgd.min.js' ), array( 'jquery' ), null, true );
		wp_register_script( 'isotope', get_theme_file_uri( '/js/libs/isotope.pkgd.min.js' ), array( 'imagesloaded' ), '3.0.1', true );
		wp_enqueue_script( 'isotopeinwp-settings', get_theme_file_uri( '/js/isotope.settings.js' ), array( 'isotope', 'jquery' ), '1.0', true );
	//}
}
